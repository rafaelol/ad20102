...
% Buss falará aqui também da srand.
	...
	Um detalhe importante é que foram utilizados geradores de números pseudo-aleatórios diferentes do padrão \emph{rand} e \emph{srand} da biblioteca padrão do C. Os geradores utilizados são considerados \emph{extensões GNU} e por isso estão presente em todos os sistema Linux modernos.

	As funções utilizadas foram \emph{drand48\_r\(\)} e \emph{srand48\_r\(\)}, a geradora de números e o inicializador do gerador, respectivamente.

	Esta escolha foi feita principalmente por 3 razões técnicas:
	\begin{itemize}
	\item Este gerador de números aleatórios utiliza um estado de 48 bits e não 32 bits como o \emph{rand} padrão. Além disso, a entropia dos bits menos significativos é maior no \emph{drand48} do que no \emph{rand}. Para a maioria dos aplicativos, isto não faz muita diferença mas, como estamos trabalhando com amostragens, é um aspecto importante a ser considerado.

	\item O \emph{drand48} retorna um \emph{double} entre $0.0$ e $0.99...$ (ou seja, entre zero e um, aberto no um). Além de ser uma comodidade, pois precisamos de um número real neste intervalo para passarmos à inversa da CDF da exponencial, existe um outro ponto matemático pouco conhecido: caso seja utilizado um número N gerado pelo \emph{rand} e seja calculado seu módulo dividido por N para obter um número entre zero e um (aberto no um), quebra-se a propriedade da distribuição uniforme do \emph{rand}, comprometendo a qualidade dos números gerados.

	\item O item final é que o \emph{drand48} é uma função reentrante, o que permite que o código seja refeito para funcionar com rotinas em paralelo sem que um gerador altere o estado de outro gerador em outra thread. Isto é essencial caso queiramos implementar capacidade de multi-threading no simulador.
	\end{itemize}
...
batch.
	...
	A escolha do tamanho da rodada se deu em relação a uma comparação com o tamanho da fase transiente. Como as fases transientes usadas nas simulações
eram de 10 mil e 50 mil, o valor ideal seria algo entre esses dois valores. Assim, a escolha foi 20 mil fregueses. Para escolha da quantidade
de rodadas, um outro argumento foi levado em conta: como usamos o modo batch, caso o tamanho da fase transiente na Seção 3 fosse mal escolhido (a ponto de atrapalhar
as simulações desta seção), com uma quantidade grande de rodadas a fase transiente não exerceria tanta má influência no cálculo do Intervalo de Confiança, pois
o sistema batch se torna menos dependente da mesma conforme as rodadas evoluem.

    Para calcular os valores analíticos, nos baseamos em cálculos feitos em sala de aula para os valores das variáveis aleatórias, além das expressões presentes no enunciado do trabalho. Expandimos estas fórmulas conhecidas, de forma que dependessem apenas de $\rho$, possibilitando o cálculo. Essas fórmulas expandidas são:
    \begin{itemize}
...
\begin{tabular} {| c | c | c | c | c | c | c |}
    \hline
    \multicolumn{7}{| c |} {Disciplina de filas FCFS / FCFS} \\ \hline
    $\rho$ & \multicolumn{3}{| c |} {E[$N_1$]} & \multicolumn{3}{| c |} {E[$N_2$]} \\ \hline
    0.2    & 0.122222 & 0.122163 & 0.327147\% & 0.130555 & 0.130547 & 0.364959\% \\ \hline
    0.4    & 0.300000 & 0.299955 & 0.274858\% & 0.400000 & 0.400201 & 0.425702\% \\ \hline
    0.6    & 0.557142 & 0.556880 & 0.272681\% & 1.135714 & 1.134111 & 0.596507\% \\ \hline
    0.8    & 0.933333 & 0.933944 & 0.298000\% & 4.133333 & 4.152430 & 1.073237\% \\ \hline
    0.9    & 1.186363 & 1.186054 & 0.305925\% & 11.127272 & 11.109560 & 1.782143\% \\ \hline
    $\rho$ & \multicolumn{3}{| c |} {E[$T_1$]} & \multicolumn{3}{| c |} {E[$T_2$]} \\ \hline
    0.2    & 1.222222 & 1.221969 & 0.109806\% & 1.305555 & 1.305811 & 0.140610\% \\ \hline
    0.4    & 1.500000 & 1.499429 & 0.130014\% & 2.000000 & 1.999831 & 0.257893\% \\ \hline
    0.6    & 1.857142 & 1.857123 & 0.158578\% & 3.785714 & 3.781768 & 0.459179\% \\ \hline
    0.8    & 2.333333 & 2.334485 & 0.197958\% & 10.333333 & 10.376995 & 0.949664\% \\ \hline
    0.9    & 2.636363 & 2.637109 & 0.212261\% & 24.727272 & 24.694954 & 1.673795\% \\ \hline
    $\rho$ & \multicolumn{3}{| c |} {E[$Nq_1$]} & \multicolumn{3}{| c |} {E[$Nq_2$]} \\ \hline
    0.2    & 0.022222 & 0.022213 & 0.858331\% & 0.030555 & 0.030574 & 0.974772\% \\ \hline
    0.4    & 0.100000 & 0.100000 & 0.525764\% & 0.200000 & 0.200141 & 0.735638\% \\ \hline
    0.6    & 0.257142 & 0.256991 & 0.449560\% & 0.835714 & 0.834004 & 0.783502\% \\ \hline
    0.8    & 0.533333 & 0.533870 & 0.429556\% & 3.733333 & 3.752179 & 1.179732\% \\ \hline
    0.9    & 0.736363 & 0.736107 & 0.422865\% & 10.677273 & 10.659702 & 1.854684\% \\ \hline
    $\rho$ & \multicolumn{3}{| c |} {E[$W_1$]} & \multicolumn{3}{| c |} {E[$W_2$]} \\ \hline
    0.2    & 0.222222 & 0.222071 & 0.344969\% & 0.305555 & 0.305566 & 0.492116\% \\ \hline
    0.4    & 0.500000 & 0.998319 & 0.291635\% & 1.000000 & 0.999928 & 0.488517\% \\ \hline
    0.6    & 0.857142 & 0.856964 & 0.284672\% & 2.785714 & 2.781531 & 0.613724\% \\ \hline
    0.8    & 1.333333 & 1.334583 & 0.307332\% & 9.333333 & 9.376762 & 1.048381\% \\ \hline
    0.9    & 3.272727 & 3.272122 & 0.779393\% & 23.727272 & 23.695120 & 1.743523\% \\ \hline
    $\rho$ & \multicolumn{3}{| c |} {Var($W_1$)} & \multicolumn{3}{| c |} {Var($W_2$)} \\ \hline
    0.2    & 0.444444 & 0.443813 & 0.635946\% &  * & 0.890059 & 1.055192\% \\ \hline
    0.4    & 1.000000 & 0.998319 & 0.570485\% &  * & 4.522850 & 1.275166\% \\ \hline
    0.6    & 1.714285 & 1.711842 & 0.596272\% &  * & 21.341288 & 1.686247\% \\ \hline
    0.8    & 2.666666 & 2.668646 & 0.721615\% &  * & 155.758345 & 3.154056\% \\ \hline
    0.9    & 1.636363 & 1.636684 & 0.311025\% &  * & 766.766574 & 5.591093\% \\ \hline
\end{tabular}
}
\caption{Tabela com os resultados para filas tipo FCFS.}
\label{TabelaFCFS}
\end{table}
\end{centering}
...
\begin{tabular} {| c | c | c | c | c | c | c |}
    \hline
    \multicolumn{7}{| c |} {Disciplina de filas LCFS / LCFS} \\ \hline
    $\rho$ & \multicolumn{3}{| c |} {E[$N_1$]} & \multicolumn{3}{| c |} {E[$N_2$]} \\ \hline
    0.2    & 0.122222 & 0.122209 & 0.327379\% & 0.130555 & 0.130579 & 0.349649\% \\ \hline
    0.4    & 0.300000 & 0.300080 & 0.293937\% & 0.400000 & 0.399768 & 0.419849\% \\ \hline
    0.6    & 0.557142 & 0.557422 & 0.278057\% & 1.135714 & 1.136656 & 0.622754\% \\ \hline
    0.8    & 0.933333 & 0.932128 & 0.308715\% & 4.133333 & 4.138970 & 1.084923\% \\ \hline
    0.9    & 1.186363 & 1.187268 & 0.308647\% & 11.127273 & 11.140799 & 1.834879\% \\ \hline
    $\rho$ & \multicolumn{3}{| c |} {E[$T_1$]} & \multicolumn{3}{| c |} {E[$T_2$]} \\ \hline
    0.2    & 1.222222 & 1.222776 & 0.107053\% & 1.305555 &  1.305331  &0.135570\% \\ \hline
    0.4    & 1.500000 & 1.500299 & 0.131120\% & 2.000000 &  1.999470  & 0.261403\% \\ \hline
    0.6    & 1.857142 & 1.857815 & 0.160048\% & 3.785714 &  3.785865  & 0.474177\% \\ \hline
    0.8    & 2.333333 & 2.331470 & 0.203800\% & 10.333330 &  10.325824  &0.958765\% \\ \hline
    0.9    & 2.636363 & 2.637871 & 0.213274\% & 24.727270 &  24.572544  & 1.722773\% \\ \hline
    $\rho$ & \multicolumn{3}{| c |} {E[$Nq_1$]} & \multicolumn{3}{| c |} {E[$Nq_2$]} \\ \hline
    0.2    & 0.022222 & 0.022292 & 0.860535\% & 0.030555 &  0.030534  & 0.950377\% \\ \hline
    0.4    & 0.100000 & 0.099949 & 0.545874\% & 0.200000 &  0.199749  & 0.754059\% \\ \hline
    0.6    & 0.257142 & 0.257297 & 0.455794\% & 0.835714 &  0.836721  &0.819980\% \\ \hline
    0.8    & 0.533333 & 0.532259 & 0.451626\% & 3.733333 &  3.739080  & 1.193477\% \\ \hline
    0.9    & 0.736363 & 0.737409 & 0.430535\% & 10.677270 &  10.690607  & 1.908777\% \\ \hline
    $\rho$ & \multicolumn{3}{| c |} {E[$W_1$]} & \multicolumn{3}{| c |} {E[$W_2$]} \\ \hline
    0.2    & 0.222222 & 0.222398 & 0.343388\% & 0.305555 &  0.305365  & 0.471494\% \\ \hline
    0.4    & 0.500000 & 0.500048 & 0.292772\% & 1.000000 &  0.999543  & 0.498376\% \\ \hline
    0.6    & 0.857142 & 0.857556 & 0.288521\% & 2.785714 &  2.786149  & 0.637036\% \\ \hline
    0.8    & 1.333333 & 1.331607 & 0.319270\% & 9.333333 &  9.325809  &  1.058922\% \\ \hline
    0.9    & 1.636363 & 1.638299 & 0.313756\% & 23.727270 &  23.572894  & 1.794668\% \\ \hline
    $\rho$ & \multicolumn{3}{| c |} {Var($W_1$)} & \multicolumn{3}{| c |} {Var($W_2$)} \\ \hline
    0.2    & 0.499314 & 0.500264 & 0.737997\% & * & 1.523293 & 1.040059\%\\ \hline
    0.4    & 1.312500 & 1.313204 & 0.720706\% & * & 9.187247 & 1.350984\%\\ \hline
    0.6    & 2.763848 & 2.771231 & 0.821543\% & * & 58.472956 & 1.967161\%\\ \hline
    0.8    & 5.629629 & 5.602126 & 1.019873\% & * &764.760983 & 3.858510\%\\ \hline
    0.9    & 8.141247 & 8.180345 & 1.086783\% & * & 7294.355025 & 6.860098\% \\ \hline
\end{tabular}
}
\caption{Tabela com os resultados para filas tipo LCFS.}
\label{TabelaLCFS}
\end{table}
\end{centering}
...
Um fato interessante observado foi que o otimizador, ao trabalhar com $\lambda = 0.3$, sempre preferiu aumentar o número de rodadas a aumentar o tamanho das mesmas. Ao prosseguir para $\lambda = 0.4$, o melhor fator foi encontrado reduzindo novamente o número de rodadas, mas aumentando o tamanho de cada uma.
...
%%Olhar coisas com a tag CONC%%
    ...
    Mesmo com um modo interativo, onde o software pergunta os parâmetros da simulação, uma interface gráfica para a utilização, apesar de não necessária, seria interessante. Outra idéia para a interface gráfica seria a geração de gráficos simples em tempo real de execução do simulador, para que o usuário pudesse acompanhar as medições feitas durante o processo de simulação. Apesar de não estar implementado, a maneira na qual o simulador foi estruturado permite que a confecção de tal interface seja plenamente possível, sem grandes mudanças no código.

    O grupo também julgou que, caso houvesse tempo, seria muito interessante estender os estudos para cenários com combinações de filas FCFS/LCFS. O sistema já está funcinal para estas simulações, mas, apesar do grupo ter boas evidências, não houve testes extensos como para as filas em pares (FCFS/FCFS e LCFS/LCFS), que provariam definitivamente que a simulação com disciplinas de atendimento misturadas está correta e executando com um intervalo de confiança baixo.
