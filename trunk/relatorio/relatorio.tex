...
\end{verbatim}
    ...
    Logo em seguida o número de fregueses atendidos que deixou o servidor se igualou ao tamanho da rodada pré estabelhecido e a simulação acaba. Podemos observar o começo da situação na qual o sistema se encontra engargalado, com uma concentração de fregueses esperando para serem servidos na segunda fila.
...
Cada resultado foi testado posteriormente com mil sementes diferentes, em uma espécie de teste de "stress" e o resultado era aprovado caso em $99.0\%$ ou mais das vezes nenhum intervalo de confiança fosse maior que $10\%$. O grupo chegou a conclusão que se no máximo 10 de 1000 simulações o tamanho do intervalo de confiança fosse um pouco maior que $10.0\%$, não seria necessário aumentar o fator, pois seria um custo benefício muito pouco, dado a grande quantidade dos testes que passam dentro do limite e com folga, ja que a verificação inicial era de $8.5\%$ (apenas relembrando, um fator candidato só era aprovado caso tivesse passado em 10 testes seguidos com todos os intervalos de confiança com tamanho menor ou igual a $8.5\%$).
